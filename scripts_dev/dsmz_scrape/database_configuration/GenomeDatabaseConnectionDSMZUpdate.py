...
import ConfigDSMZUpdate


class GenomeDatabaseConnectionDSMZUpdate(object):
    ...
    def MakePostgresConnection(self):
        db_name = ConfigDSMZUpdate.GTDB_DB_NAME
        conn_string = "dbname=%s user=%s host=%s password=%s" % (
            db_name, ConfigDSMZUpdate.GTDB_USERNAME,
            ConfigDSMZUpdate.GTDB_HOST, ConfigDSMZUpdate.GTDB_PASSWORD
        )
