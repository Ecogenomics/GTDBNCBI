...
import ConfigLPSNUpdate


class GenomeDatabaseConnectionLPSNUpdate(object):
    ...
    def MakePostgresConnection(self):
        db_name = ConfigLPSNUpdate.GTDB_DB_NAME
        conn_string = "dbname=%s user=%s host=%s password=%s" % (
            db_name, ConfigLPSNUpdate.GTDB_USERNAME,
            ConfigLPSNUpdate.GTDB_HOST, ConfigLPSNUpdate.GTDB_PASSWORD
        )
