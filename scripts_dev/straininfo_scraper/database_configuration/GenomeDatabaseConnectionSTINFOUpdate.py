...
import ConfigSTINFOUpdate


class GenomeDatabaseConnectionSTINFOUpdate(object):
    ...
    def MakePostgresConnection(self):
        db_name = ConfigSTINFOUpdate.GTDB_DB_NAME
        conn_string = "dbname=%s user=%s host=%s password=%s" % (
            db_name, ConfigSTINFOUpdate.GTDB_USERNAME,
            ConfigSTINFOUpdate.GTDB_HOST, ConfigSTINFOUpdate.GTDB_PASSWORD
        )
